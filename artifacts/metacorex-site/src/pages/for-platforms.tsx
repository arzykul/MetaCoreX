...
export default function ForPlatforms() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col font-sans">
      <PageSeo
        title="For Platforms"
        description="Integrate MetaCoreX verification into your platform. Access cashback rewards and on-chain proof-of-usefulness data for AI agent work."
        canonical="/for-platforms"
      />
      <Navbar />
